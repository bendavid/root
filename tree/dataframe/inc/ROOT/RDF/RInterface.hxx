...
public:
   ...
   /// present. \tparam OtherColumns A list of the other types of the columns the values of which are used to fill the
   /// object. \param[in] model The returned histogram will be constructed using this as a model. \param[in] columnList
